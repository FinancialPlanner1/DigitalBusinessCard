...
<body>
    <div class="container">
        ...
        <div class="sitemap-section">
            ...
            <div class="sitemap-list">
                <ul>
                    <li><a href="#about-me" class="smooth-scroll">About Me</a></li>
                    <li><a href="#qualifications" class="smooth-scroll">Qualifications</a></li>
    ...
    <script>
        // This script is for additional smooth scroll control (optional)
